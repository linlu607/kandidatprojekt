...
tweepy (twitter API. There is an error in the version available through pip as of 2017-04-20, use a manuall install of the latest version from Github untill a newer version comes to pip)
