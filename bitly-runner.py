    ...
    while (runs < 1):
        ...
        for line in lines:
            if ((line not in haveread) and (line != '')):
                ...
                # Random tweets
                bitlydatahandler.handleTweets(tweetsPath=line, numToRead=2000, outfile=random_file_path, newsOnly=0, c=c)
                # News tweets
                bitlydatahandler.handleTweets(tweetsPath=line, numToRead=2000, outfile=news_file_path, newsOnly=1, c=c)
